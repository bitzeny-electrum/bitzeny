...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bitzeny-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitzeny-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitzeny transaction") + "\n" +
              "  bitzeny-tx [options] -create [commands]   " + _("Create hex-encoded bitzeny transaction") + "\n" +
              "\n";
